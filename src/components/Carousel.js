  ...
  return (
    <div className="carousel" id="carousel">
      ...
      <div className="carousel-body container">
        <div
          className={firstBtn ? "carousel-container" : "carousel-not-active"}
        >
          ...
          <div className="carousel-comments-section">
            <div
              className={
                firstPage ? "carousel-single-page" : "carousel-single-page-none"
              }
            >
              <div className="carousel-single-comment">
                <div className="comment-heading">
                  <p className="carousel-comment-title">
                    Fundacja “Dbam o Zdrowie”
                  </p>
                  <span className="carousel-comment-snippet font-italic">
                    Cel i misja: Pomoc osobom znajdującym się w trudnej sytuacji
                    życiowej.
                  </span>
                </div>
                <span className="carousel-comment-snippet">
            ...
            <div
              className={
                secondPage
                  ...
                  : "carousel-single-page-none"
              }
            >
              <div className="carousel-single-comment">
                <div className="comment-heading">
                  <p className="carousel-comment-title">
                    Fundacja “Druga strona”
                  </p>
                  <span className="carousel-comment-snippet font-italic">
                    Cel i misja: Pomoc osobom znajdującym się w trudnej sytuacji
                    życiowej.
            ...
            <div
              className={
                thirdPage ? "carousel-single-page" : "carousel-single-page-none"
              }
            >
              <div className="carousel-single-comment">
                <div className="comment-heading">
                  <p className="carousel-comment-title">
                    Fundacja “Trzecia strona”
                  </p>
                  <span className="carousel-comment-snippet font-italic">
                    Cel i misja: Pomoc osobom znajdującym się w trudnej sytuacji
                    życiowej.
          ...
          <div className="carousel-pagination">
            <button
              className={
                firstPage ? "carousel-page-btn-active" : "carousel-page-btn"
              }
            ...
            <button
              className={
                secondPage ? "carousel-page-btn-active" : "carousel-page-btn"
              }
            ...
            <button
              className={
                thirdPage ? "carousel-page-btn-active" : "carousel-page-btn"
              }
        ...
        <div
          className={secondBtn ? "carousel-container" : "carousel-not-active"}
        >
          <h4 className="carousel-heading">
        ...
        <div
          className={thirdBtn ? "carousel-container" : "carousel-not-active"}
        >
          <h4 className="carousel-heading">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
